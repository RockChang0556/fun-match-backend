...
export interface AutoMapperItem {
  mapperToClass: ClassConstructor<any>;
...
export class AutoMapper {
  ...
  static getMapper<T extends BaseEntity>(
    ...
    return this.mappers.get(entityContructor as ClassConstructor<BaseEntity>);
  }
  static MapperTo<T extends BaseEntity>(
    entity: T | T[],
    targetMapper?: ClassConstructor<any>,
    options?: ClassTransformOptions,
  ): ClassConstructor<any> | ClassConstructor<any>[] | T | T[] {
    if (!targetMapper) {
